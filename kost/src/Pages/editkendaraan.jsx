...
const EditKendaraan = () => {
  ...
  const getKendaraanById = async () => {
    const response = await axios.get(`http://localhost:3001/kendaraan/${id}`);
    setFile(response.data.loadImage);
    setPreview(response.data.url);
    setdeskripsi(response.data.deskripsi);
    setH1(response.data.h1);
    setH2(response.data.h2);
    setH3(response.data.h3);
    setH4(response.data.h4);
    setH5(response.data.h5);
    setH6(response.data.h6);
    setHargau(response.data.hargau);
    setLokasi(response.data.lokasi);
    setMaps(response.data.maps);
    setPs1(response.data.ps1);
    setPs2(response.data.ps2);
    setPs3(response.data.ps3);
    setSp1(response.data.sp1);
    setSp2(response.data.sp2);
    setSp3(response.data.sp3);
    setSp4(response.data.sp4);
    setSp5(response.data.sp5);
    setSpeku(response.data.speku);
    setSs1(response.data.ss1);
    setSs2(response.data.ss2);
    setSs3(response.data.ss3);
    setSs4(response.data.ss4);
    setsTelepon(response.data.telepon);
    setTransmisi(response.data.transmisi);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.patch(`http://localhost:3001/kendaraan/${id}`, formData, {
        headers: {
        ...
        <Row className="info">
          ...
          >
            <Col md={3} style={{ marginRight: "8%", marginTop: "20px" }}>
              ...
              <p style={{ fontSize: "12px", opacity: 0.6 }}>
                Informasi Kendaraan min.40 karakter, yang didalamnya memuat nama
                kost dan wilayahnya
              </p>
            </Col>
            <Col md={8}>
